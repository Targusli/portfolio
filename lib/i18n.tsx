...
const translations = {
  en: {
    ...
    skills: {
      ...
      toolsIntro: 'Tools and skills applied daily — the foundation of my work.',
  ...
  de: {
    ...
    skills: {
      ...
      toolsIntro: 'Im Alltag angewandte Tools und Skills, auf welche ich mein Können aufbaue.',
